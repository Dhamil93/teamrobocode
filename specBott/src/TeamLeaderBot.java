...
public class TeamLeaderBot extends TeamRobot {
    ...
    public void run() {
        ...
        setColors(Color.pink,Color.pink,Color.red,Color.green, Color.red);//body,gun,radar,bullet,radarArc
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
        ...
        if (!(isTeammate(e.getName()))) {
            ...
            try{
                broadcastMessage("" + enemy.getX() + ", " + enemy.getY() + ", " + enemy.heading + ", " + enemy.velocity);
